...
export function Settings() {
  ...
  const azureConfigComponent = null;
  const googleConfigComponent = null;
  const anthropicConfigComponent = null;
  const baiduConfigComponent = null;
  const tencentConfigComponent = null;
  const byteDanceConfigComponent = null;

  const alibabaConfigComponent = null; // Removed

  const moonshotConfigComponent = null; // Removed

  const deepseekConfigComponent = null; // Removed

  const XAIConfigComponent = null; // Removed

  const chatglmConfigComponent = null; // Removed
  const siliconflowConfigComponent = null; // Removed

  const stabilityConfigComponent = null; // Removed
  const lflytekConfigComponent = null; // Removed
